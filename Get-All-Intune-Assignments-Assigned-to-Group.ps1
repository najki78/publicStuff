...
# source: https://www.tftd.co.uk/2021/07/23/managing-intune-with-powershell/#get-all-intune-assignements-assigned-to-group
# thanks to https://timmyit.com/2019/12/04/get-all-assigned-intune-policies-and-apps-per-azure-ad-group/
...
#get-help Update-MSGraphEnvironment -full
