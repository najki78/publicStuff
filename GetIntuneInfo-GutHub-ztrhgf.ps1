...
# https://github.com/ztrhgf/useful_powershell_functions/blob/master/INTUNE/Invoke-IntuneScriptRedeploy.ps1
...
#Invoke-IntuneScriptRedeploy  -scriptType script -computerName M5332696

Get-ClientIntunePolicyResult  -asHTML -getDataFromIntune -showConnectionData -showEnrollmentIDs -showURLs -HTMLReportPath "C:\temp"
